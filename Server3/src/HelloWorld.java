   ...
   // String pRemota;
    ...
    public void streamer() {
        ...
        try {
            ...
            String frase = "Server 3 -- ## 1 - Adicionar anuncio ## 2 - Listar  veiculos ## 3 - Sair do sistema ##";
    ...
    public synchronized void adicionaCar() {
        ...
        for (i = 0; i < frase3.length; ++i) {
            ...
            try {
                ...
                frase[i] = str1;
                System.out.println("Até aqui chega: "+str1);
    ...
    public void listAll() {
        ...
        for (int i = 0; i < tam; i++) {
            ...
            try {
                pr1 = new PrintWriter(this.connection.getOutputStream());
                pr1.println(dadosVeiculo);
                pr1.flush();
